...
public class MemberController {
	...
	public String signUpMemberForm(Member member) {
...
//		}
	...
	@GetMapping("updatePwdCheck")
	public String updatePwdCheck(Member member, Model model) {
	...
	public String updatePageView(Member member, Model model) {
	...
	@GetMapping("pwdCheck")
	public String pwdCheck(Member member, Model model) {
	...
	public String myPageView(Member member, Model model) {
		model.addAttribute("member", memberService.getMember(member));
		return "member/myPageView";
	}
	...
	public String myPage(Member member) {
		...
		memberService.myPageMember(member);
